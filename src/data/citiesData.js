    ...
    interventions: [
      {
        ...
        impact: 'Major regulatory framework introduced',
        affectedPollutants: ['pm10', 'so2', 'no2', 'co'],
      },
      {
        year: 1975,
        title: 'Catalytic Converters Mandated',
        description: 'New cars required to have catalytic converters for reducing tailpipe emissions of NOx, CO, and hydrocarbons.',
        impact: 'Vehicle emissions declined ~75% after implementation',
      ...
      },
      {
        ...
        impact: 'Smog-forming emissions decreased ~15% following program',
      ...
      },
      {
        ...
        impact: 'Port-area emissions dropped ~87% in subsequent years',
    ...
    interventions: [
      {
        ...
        impact: 'AQI decreased ~30% during event period',
      ...
      },
      {
        ...
        impact: 'Aggressive PM2.5 reduction targets established',
      ...
      },
      {
        ...
        impact: 'Winter PM2.5 levels declined ~25% afterward',
      ...
      },
      {
        ...
        impact: 'New vehicle emissions estimated ~50% lower',
    ...
    interventions: [
      {
        ...
        impact: 'Coal smog incidents declined dramatically',
      ...
      },
      {
        ...
        impact: 'Smoke emissions dropped ~80% in following years',
      ...
      },
      {
        ...
        impact: 'Central London traffic decreased ~30%',
        affectedPollutants: ['no2', 'pm25', 'co'],
      },
      {
        year: 2019,
        ...
        impact: 'Roadside NO2 declined ~44% in central zone',
    ...
    interventions: [
      {
        ...
        impact: 'Daily vehicle circulation decreased ~20%',
      ...
      },
      {
        ...
        impact: 'Lead emissions dropped ~95% after transition',
      ...
      },
      {
        ...
        impact: 'Now serves 1M+ passengers daily',
        affectedPollutants: ['no2', 'pm25', 'co'],
      },
      {
        year: 2014,
        ...
        impact: 'Ozone levels declined ~70% from 1990 baseline',
    ...
    interventions: [
      {
        ...
        impact: 'Temporary ~15% decrease during trial periods',
        affectedPollutants: ['no2', 'pm25', 'co'],
      },
      {
        year: 2017,
        ...
        impact: 'New diesel vehicles emit ~70% less NOx',
      ...
      },
      {
        ...
        impact: 'Variable impact, estimated 5-10% during restrictions',
      ...
      },
      {
        ...
        impact: 'Ongoing implementation, limited measurable impact',
    ...
    interventions: [
      {
        ...
        impact: 'Industrial SO2 declined ~50% within 5 years',
      ...
      },
      {
        ...
        impact: 'Particulate matter dropped ~80% in subsequent period',
      ...
      },
      {
        ...
        impact: '100,000+ high-emission vehicles retired',
      ...
      },
      {
        ...
        impact: 'Covered facilities reported ~25% CO2 reduction',
    ...
    interventions: [
      {
        ...
        impact: 'Bus fleet emissions declined ~90%',
      ...
      },
      {
        ...
        impact: '2M+ participants enrolled, raised awareness',
      ...
      },
      {
        ...
        impact: 'Peak day PM2.5 decreased ~20% during activations',
        affectedPollutants: ['pm25', 'pm10'],
      },
      {
        year: 2021,
        ...
        impact: 'Multi-year implementation ongoing',
        affectedPollutants: ['pm25', 'pm10', 'no2'],
      },
    ],
  },
    ...
    interventions: [
      {
        ...
        impact: 'Pioneering local air quality regulation enacted',
        affectedPollutants: ['pm10', 'so2', 'co'],
      },
      {
        year: 1947,
        ...
        impact: 'Particulate matter dropped ~60% following enforcement',
        affectedPollutants: ['pm10', 'so2'],
      },
      {
        year: 1980,
        ...
        impact: 'Economic transition coincided with major AQ improvement',
        affectedPollutants: ['pm10', 'so2', 'no2', 'co'],
      },
      {
        year: 2003,
        ...
        impact: 'Targeted remaining industrial emission sources',
