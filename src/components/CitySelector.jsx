export default function CitySelector({ cities, selectedCity, onSelectCity }) {
  return (
    <select
      ...
      className="w-full px-1 py-2 bg-transparent border-0 border-b border-ink text-base md:text-lg font-serif font-medium focus:outline-none focus:border-ink transition-all min-h-[44px] appearance-none cursor-pointer text-ink"
      style={{
