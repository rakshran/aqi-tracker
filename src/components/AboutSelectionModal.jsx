export default function AboutSelectionModal({ isOpen, onClose }) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div className="fixed inset-0 bg-ink/40 z-50" onClick={onClose} aria-hidden="true" />
          ...
          >
            ...
            <div className="px-6 py-6 space-y-8 text-sm">
              ...
              <div className="border-l-2 border-accent pl-4 py-2">
                <h3 className="font-sans text-xs uppercase tracking-widest text-ink/40 mb-2">
              ...
              <section>
                <h3 className="font-serif text-lg font-bold text-ink mb-3">
                  Selection Bias in This Dataset
                </h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t border-grid pt-3">
                    ...
                    <p className="font-sans text-ink/60 mb-2">
                      <strong className="text-ink/80">What&apos;s included:</strong> Cities that
                      experienced measurable improvements or implemented major interventions
                    </p>
                    <p className="font-sans text-ink/60 mb-1">
                      <strong className="text-ink/80">What&apos;s missing:</strong>
                    </p>
                  ...
                  <div className="border-t border-grid pt-3">
                    ...
                    <p className="font-sans text-ink/60 mb-2">
                      <strong className="text-ink/80">Regions represented:</strong> North America (3
                      cities), Europe (1 city), Asia (4 cities)
                    </p>
                    <p className="font-sans text-ink/60 mb-1">
                      <strong className="text-ink/80">Regions missing:</strong>
                    </p>
                    <ul className="font-sans text-ink/50 ml-4 text-xs space-y-0.5">
              ...
              <section>
                ...
                <ul className="space-y-1.5 font-sans text-ink/60 ml-4">
                  <li>
                    — <strong className="text-ink/80">Overstating policy effectiveness:</strong>{' '}
                    Showing primarily positive outcomes may suggest policies are more uniformly
                    successful than reality
                  </li>
                  <li>
                    — <strong className="text-ink/80">Underrepresenting challenges:</strong>{' '}
                    Difficulty of addressing pollution in rapidly industrializing regions is not
                    fully captured
                  </li>
                  <li>
                    — <strong className="text-ink/80">Creating false optimism:</strong> May suggest
                    pollution problems are easily solved, ignoring structural barriers
                  </li>
                </ul>
              </section>
              ...
              <section className="border-t border-grid pt-4">
                <h3 className="font-sans text-xs uppercase tracking-widest text-ink/40 mb-3">
                ...
                <ul className="space-y-1 text-xs font-sans">
                  ...
                  <li>
                    <a
                      href="https://www.who.int/data/gho/data/themes/air-pollution"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-ink/60 underline hover:text-ink transition-colors"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.iqair.com/world-air-quality-report"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-ink/60 underline hover:text-ink transition-colors"
                    >
